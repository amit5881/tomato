...
class ResturantsControllerTest < ActionController::TestCase
  ...
  test "should create resturant" do
    assert_difference('Resturant.count') do
      post :create, resturant: { description: @resturant.description, image: @resturant.image, name: @resturant.name }
    end
  ...
  test "should update resturant" do
    put :update, id: @resturant, resturant: { description: @resturant.description, image: @resturant.image, name: @resturant.name }
    assert_redirected_to resturant_path(assigns(:resturant))
  end
